...
;inicializar o ambiente com a cor verde (relva):
to setup
  clear-all
  reset-ticks
  ask patches[
  ...
  ; 3 corta relvas: tamanho, forma e movimentos...
  create-turtles 3[
...
to go
  ; Regras para o movimento  do corta relvas:
  ask turtles [
    set moveok 0
    ...
    ; caso não tenha relva por cortar, nem à frente nem dos lados (direito ou esquerdo)
